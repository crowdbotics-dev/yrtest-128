"""
Django settings for yrtest_128 project.
...
WSGI_APPLICATION = 'yrtest_128.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yrtest_128 API",
    "DESCRIPTION": "API documentation for yrtest_128 App",
    "VERSION": "v1",
}
